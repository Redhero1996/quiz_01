@extends('master')
@section('title', '| ' . __('translate.all_roles'))
@section('content')
    <div class="card">
        <div class="card-body">
            <h3 class="page-title">{{ __('translate.manage_roles') }}</h3>
            <!-- BEGIN PAGE CONTENT-->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption mb-2">
                                <i class="fa fa-globe"></i>{{ __('translate.all_roles') }}
                            </div>
                            <div class="tools">
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $role->id }}</td>
                                    <td>{{ $role->name }}</td>
                                    <td><a class="edit" href="{{ route('roles.edit', $role->id) }}">
                                        <i class="fa fa-edit"></i> {{ __('translate.edit') }}
                                        </a>
                                    </td>
                                    <td>
                                        <a class="delete" data-toggle="modal" href="#delete-{{$role->id}}">
